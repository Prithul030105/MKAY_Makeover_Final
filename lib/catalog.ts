...
product({
  ...
  product({
    id: 'mkay-vs-ggg',
    code: 'VS-GGG',
    name: 'VS-GGG Printed Travel Backpack',
    slug: 'vs-ggg-printed-travel-backpack',
    categorySlug: 'travel-makeup-cases',
    material: 'Fabric travel backpack',
    finish: 'Printed multi-colour finish',
    dimensions: 'Compact backpack',
    images: ['/Product_21.jpeg'],
    description: 'A stylish printed travel backpack available in multiple colours, designed for carrying beauty essentials, personal items and everyday accessories. Its practical backpack format makes it easy to carry while travelling or working on the go.',
    tags: ['travel backpack', 'printed backpack', 'beauty bag', 'multi-colour'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-vs-fff',
    code: 'VS-FFF',
    name: 'VS-FFF Floral Printed Travel Backpack',
    slug: 'vs-fff-floral-printed-travel-backpack',
    categorySlug: 'travel-makeup-cases',
    material: 'Fabric travel backpack',
    finish: 'Floral printed finish',
    dimensions: 'Compact backpack',
    images: ['/Product_22.jpeg'],
    description: 'A colourful floral-print travel backpack designed for practical everyday carrying. Available in multiple colour combinations, it offers a lightweight and versatile option for beauty professionals, students and travel use.',
    tags: ['travel backpack', 'floral', 'printed bag', 'beauty bag'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-vs-aaa',
    code: 'VS-AAA',
    name: 'VS-AAA Pink Printed Travel Backpack',
    slug: 'vs-aaa-pink-printed-travel-backpack',
    categorySlug: 'travel-makeup-cases',
    material: 'Fabric travel backpack',
    finish: 'Pink printed finish',
    dimensions: 'Compact backpack',
    images: ['/Product_23.jpeg'],
    description: 'A playful printed travel backpack available in several pink and dark colour combinations. Designed for convenient everyday carrying of beauty products, accessories and personal essentials.',
    tags: ['travel backpack', 'pink backpack', 'printed bag', 'beauty bag'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-vs-002',
    code: 'VS-002',
    name: 'VS-002 Character Travel Backpack',
    slug: 'vs-002-character-travel-backpack',
    categorySlug: 'travel-makeup-cases',
    material: 'Fabric travel backpack',
    finish: 'Character printed finish',
    dimensions: 'Compact backpack',
    images: ['/Product_24.jpeg'],
    description: 'A character-themed travel backpack available in multiple colours, combining a playful design with a practical everyday carrying format. Suitable for beauty essentials, accessories and travel requirements.',
    tags: ['travel backpack', 'character design', 'printed backpack', 'beauty bag'],
    featured: false,
  }),

  product({
    id: 'mkay-green-print-case',
    code: 'MKAY-GREEN-PRINT',
    name: 'Green Printed Cosmetic Travel Case',
    slug: 'green-printed-cosmetic-travel-case',
    categorySlug: 'travel-makeup-cases',
    material: 'Structured fabric cosmetic case',
    finish: 'Green fruit-pattern printed finish',
    dimensions: 'Compact cosmetic case',
    images: ['/Product_25.jpeg'],
    description: 'A compact cosmetic travel case featuring a playful green printed exterior and a structured shape for storing makeup, toiletries and beauty accessories. Its compact format makes it convenient for travel and everyday organisation.',
    tags: ['cosmetic case', 'travel case', 'green', 'printed', 'makeup organiser'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-001',
    code: 'MKAY-001',
    name: 'MKAY-001 Compact Hard Shell Beauty Case',
    slug: 'mkay-001-compact-hard-shell-beauty-case',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Hard shell case',
    finish: 'Textured pastel finish',
    dimensions: 'Compact beauty case',
    images: ['/Product_26.jpeg'],
    description: 'A compact hard shell beauty case available in a range of pastel and vibrant finishes. Its structured design provides a practical way to organise makeup, beauty accessories and personal essentials.',
    tags: ['beauty case', 'hard shell', 'compact', 'pastel', 'makeup case'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-006',
    code: 'MKAY-006',
    name: 'MKAY-006 Textured Compact Beauty Case',
    slug: 'mkay-006-textured-compact-beauty-case',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Hard shell case',
    finish: 'Textured pastel finish',
    dimensions: 'Compact beauty case',
    images: ['/Product_27.jpeg'],
    description: 'A compact textured beauty case offered in multiple pastel colours. The structured hard shell design makes it suitable for organising makeup, cosmetics and smaller beauty accessories.',
    tags: ['beauty case', 'hard shell', 'textured', 'pastel', 'cosmetics'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-s1',
    code: 'S-1',
    name: 'S-1 12-Piece Makeup Box Collection',
    slug: 's-1-12-piece-makeup-box-collection',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Structured makeup boxes',
    finish: 'Mixed pastel, glitter and metallic finishes',
    dimensions: '27.5 × 18 × 21.5 cm',
    images: ['/Product_28.jpeg'],
    description: 'A 12-piece collection of compact makeup and beauty boxes in a variety of colours, textures and finishes. The assortment includes practical storage formats suitable for makeup, jewellery, gifting and beauty organisation.',
    tags: ['12 piece set', 'makeup boxes', 'beauty boxes', 'storage', 'gift boxes'],
    featured: false,
  }),

  product({
    id: 'mkay-s1-duplicate',
    code: 'S-1',
    name: 'S-1 12-Piece Makeup Box Collection',
    slug: 's-1-12-piece-makeup-box-collection-2',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Structured makeup boxes',
    finish: 'Mixed pastel, glitter and metallic finishes',
    dimensions: '27.5 × 18 × 21.5 cm',
    images: ['/Product_29.jpeg'],
    description: 'A 12-piece collection of compact makeup and beauty boxes in a variety of colours, textures and finishes. The assortment includes practical storage formats suitable for makeup, jewellery, gifting and beauty organisation.',
    tags: ['12 piece set', 'makeup boxes', 'beauty boxes', 'storage', 'gift boxes'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-vs-005',
    code: 'VS-005',
    name: 'VS-005 Character Print Travel Backpack',
    slug: 'vs-005-character-print-travel-backpack',
    categorySlug: 'travel-makeup-cases',
    material: 'Fabric travel backpack',
    finish: 'Character printed finish',
    dimensions: 'Compact backpack',
    images: ['/Product_30.jpeg'],
    description: 'A character-print travel backpack available in multiple colours. Its practical backpack format provides convenient everyday storage for beauty products, accessories and personal essentials.',
    tags: ['travel backpack', 'character print', 'beauty bag', 'multi-colour'],
    featured: false,
  }),

  product({
    id: 'mkay-bear-mini-case',
    code: 'MKAY-BEAR-MINI',
    name: 'Bear Character Mini Beauty Case',
    slug: 'bear-character-mini-beauty-case',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Hard shell case',
    finish: 'Bear character embossed finish',
    dimensions: 'Compact mini beauty case',
    images: ['/Product_31.jpeg'],
    description: 'A cute compact hard shell beauty case featuring a bear character design and rounded carry handle. Its small format is ideal for storing selected cosmetics, accessories and everyday beauty essentials.',
    tags: ['mini beauty case', 'bear design', 'hard shell', 'cute', 'makeup case'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-008',
    code: 'MKAY-008',
    name: 'MKAY-008 Textured Mini Beauty Case',
    slug: 'mkay-008-textured-mini-beauty-case',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Hard shell case',
    finish: 'Textured metallic and pastel finish',
    dimensions: 'Compact mini beauty case',
    images: ['/Product_32.jpeg'],
    description: 'A compact hard shell beauty case with a distinctive textured exterior and a selection of pastel and metallic colour options. Designed for organised storage of cosmetics, accessories and small personal essentials.',
    tags: ['mini beauty case', 'hard shell', 'textured', 'pastel', 'metallic'],
    featured: false,
  }),
  ...
  product({
    id: 'mkay-a4',
    code: 'A-4',
    name: 'A-4 12-Piece Makeup Box Collection',
    slug: 'a-4-12-piece-makeup-box-collection',
    categorySlug: 'vanity-makeup-boxes',
    material: 'Structured makeup boxes',
    finish: 'Pastel, glitter and metallic finishes',
    dimensions: '27.5 × 18 × 22 cm',
    images: ['/Product_33.jpeg'],
    description: 'A 12-piece assortment of structured makeup and beauty boxes in a selection of pastel, glitter and metallic finishes. Designed for organised storage, gifting and professional beauty requirements.',
    tags: ['12 piece set', 'makeup boxes', 'beauty boxes', 'storage', 'gift boxes'],
    featured: false,
  }),
